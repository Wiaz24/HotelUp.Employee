...
namespace HotelUp.Employee.API.Swagger;
...
internal static class Extensions
{
    internal static IServiceCollection AddCustomSwagger(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddSwaggerGen(options =>
        {
            ...
            options.SwaggerDoc("v1", new OpenApiInfo { Title = "HotelUp.Employee", Version = "v1" });
    ...
    internal static IApplicationBuilder UseCustomSwagger(this IApplicationBuilder app)
    {
        ...
        app.UseSwagger(c => { c.RouteTemplate = $"api/employee/swagger/{{documentName}}/swagger.json"; });
        app.UseSwaggerUI(c =>
        {
            c.DocumentTitle = "HotelUp.Employee";
            c.SwaggerEndpoint($"/api/employee/swagger/v1/swagger.json", "API V1");
